...
def main():
    ...
    for exp in range(start_exp, args.num_exp):
        if args.save_path != "":
            checkpoint_name = "./output/{dst}/{net}/{mtd}/exp{exp}_epoch{epc}_{dat}_{fr}_".format(dst=args.dataset,
                                                                                         net=args.model,
                                                                                         mtd=args.selection,
                                                                                         dat=datetime.now(),
                                                                                         exp=start_exp,
        ...
        print("Target distribution in the subset: ", Counter(list(dst_subset.dataset.targets[subset["indices"].copy()].cpu().numpy())))
